 ...
 * @param unioningType 
 */
data class OperatorExpressionRequestAnyOf(
    val atType: OperatorExpressionRequestAnyOf.AtType,
    ...
    val `operator`: ActionDefinitionRequestAnyOfDeclaredShortName? = null,
