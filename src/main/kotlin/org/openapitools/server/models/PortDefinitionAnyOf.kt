 ...
 */
data class PortDefinitionAnyOf(
    val atId: java.util.UUID,
    val atType: PortDefinitionAnyOf.AtType,
    val aliasIds: kotlin.collections.List<kotlin.String>,
    val conjugatedPortDefinition: ActionUsageRequestAnyOfMultiplicity,
