 ...
 */
data class RequirementUsageAnyOf(
    val atId: java.util.UUID,
    val atType: RequirementUsageAnyOf.AtType,
    ...
    val reqId: ActionDefinitionRequestAnyOfDeclaredShortName,
    val requiredConstraint: kotlin.collections.List<Identified>,
    val requirementDefinition: ActionUsageRequestAnyOfMultiplicity,
