...
import org.openmbee.flexo.sysmlv2.models.SuccessionRequestAnyOf
 ...
 */
@Serializable
data class SuccessionRequest(
    @SerializedName("@type")
    val atType: SuccessionRequest.AtType,
    @SerializedName("@id")
