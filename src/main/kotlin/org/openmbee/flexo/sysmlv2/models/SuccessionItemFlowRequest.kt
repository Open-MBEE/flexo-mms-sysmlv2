...
import org.openmbee.flexo.sysmlv2.models.SuccessionItemFlowRequestAnyOf
 ...
 */
@Serializable
data class SuccessionItemFlowRequest(
    @SerializedName("@type")
    val atType: SuccessionItemFlowRequest.AtType,
    @SerializedName("@id")
