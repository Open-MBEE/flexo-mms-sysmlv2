 ...
 */
@Serializable
data class UseCaseUsageRequestAnyOf(
    @SerialName("@type")
    val atType: UseCaseUsageRequestAnyOf.AtType,
    @SerialName("@id")
    ...
    val calculationDefinition: ActionUsageRequestAnyOfMultiplicity? = null,
    val caseDefinition: ActionUsageRequestAnyOfMultiplicity? = null,
    ...
    val objectiveRequirement: ActionUsageRequestAnyOfMultiplicity? = null,
