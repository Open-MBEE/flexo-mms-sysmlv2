 ...
 */
@Serializable
data class UseCaseUsageAnyOf(
    @SerialName("@id")
    val atId: java.util.UUID,
    @SerialName("@type")
    val atType: UseCaseUsageAnyOf.AtType,
    ...
    val calculationDefinition: ActionUsageRequestAnyOfMultiplicity,
    val caseDefinition: ActionUsageRequestAnyOfMultiplicity,
    ...
    val objectiveRequirement: ActionUsageRequestAnyOfMultiplicity,
