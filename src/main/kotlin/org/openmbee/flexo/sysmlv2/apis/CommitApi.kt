...
import com.modeldriven.sysmlv2.apiService.RdfServiceFlexo
...
fun Route.CommitApi() {
    ...
    post<CommitRequest>("/projects/{projectId}/commits") { commit ->
        ...
        val modelGraph = GraphConfig("Model", "urn:sysmlv2:") // DEPENDS ON PROJECT??
        val projectGraph = GraphConfig("Project", "urn:sysmlv2project:")
        val rdfService = RdfServiceFlexo(modelGraph, projectGraph, context = context, projectId = projectId)
        val crudService = ApiCrudService(rdfService)
